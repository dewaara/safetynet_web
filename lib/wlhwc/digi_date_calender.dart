...
class DateCalenders extends StatefulWidget {
  const DateCalenders({Key? key}) : super(key: key);

  @override
  State<DateCalenders> createState() => _DateCalendersState();
}

class _DateCalendersState extends State<DateCalenders> {
  int touchedIndex = -1;
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        children: [
          Expanded(child: _otherExpanses(MockData.otherExpanses)),
  ...
  Widget _otherExpanses(List<Usages> otherUsages) {
    return Container(
